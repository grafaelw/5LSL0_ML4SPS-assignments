...
def create_dataloaders(data_loc, batch_size):
    ...
    train_set, val_set = random_split(Noisy_MNIST_train, [50000, 10000])
...
if __name__ == "__main__":
    ...
    data_loc = os.getcwd() + '/Datasets' #change the datalocation to something that works for you
    batch_size = 64
    ...
    plt.savefig("data_examples.eps",bbox_inches='tight')
    plt.show()